"""Test combination to be used in the registration tests"""
...
INVALID_EMAIL_COMBINATIONS = [
    ...
    (
        invalid_user["email_without_letter_after_the_comma"],
...
INVALID_PASSWORD_COMBINATIONS = [
    ...
    (
        invalid_user["password_with_only_lower_cased_letters"],
        error_message["password_without_upper_cased_letter"],
    ),
    (
        invalid_user["password_with-only_upper_cased_letters"],
        error_message["password_without_lower_cased_letter"],
    ),
    (
        invalid_user["password_without_numbers"],
        error_message["password_without_number"],
    ),
