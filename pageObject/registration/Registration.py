...
class Registration:
    def __init__(self, page):
        ...
        self.terms_and_conditions_checkbox = page.get_by_role("checkbox", name="I agree to the terms and conditions")
        self.register_button = page.get_by_role("button", name="Register")
        self.terms_and_conditions_link = page.get_by_role("link", name="terms and conditions")
        self.login_link = page.get_by_text("Login here").nth(0)
        self.show_password_button = page.locator(".sc-a9b05490-1 > form > div:nth-child(3) > .sc-a2612d62-5")
        self.show_confirm_password_button = page.locator(".sc-a9b05490-1 > form > div:nth-child(4) > .sc-a2612d62-5")
        self.email_notification = page.locator('form > div:nth-child(2) > label').nth(0)
        self.password_notification = page.locator('form > div:nth-child(3) > label').nth(0)
        self.conf_pass_notification = page.locator('form > div.sc-a2612d62-1.cZXQFx.sc-23ae1b82-1.lnRuL > label').nth(0)
        self.date_notification = page.locator('form > div.sc-c1509d-0.jGkKKJ > label').nth(0)
        self.tac_notifications = page.locator('form > label').nth(0)
        self.terms_and_conditions_error_message = 'Terms and conditions must be accepted'
